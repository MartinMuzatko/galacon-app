...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('app', '<header class="appmenu"> Galacon Conguide <a onclick="{back}" if="{view!=\'main\'}">back to app</a> </header> <section if="{view==\'main\'}" class="animated" name="menu" layout="row" layout-align="space-between start"> <card card="{card}" key="{key}" onclick="{select}" class="card card-{key}" flex="33" each="{key, card in cards}"> <img riot-src="img/card/{key}.png" alt=""> <footer view="card" data-is="{key}"> </footer> </card> </section> <main if="{view==\'card\'}" class="animated" name="content"></main>', '', '', function (opts) {
	    var _this = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('event', '<h2>Events</h2> <div> <section class="scheduler"> <div class="pointer" riot-style="top: {pointerTime}em"></div> <div class="timeAxis"> <div layout="column" each="{hour in timespan}" riot-style="height: {scale}em" class="hour"> <div each="{step in timesteps}"> {pad(hour,2)}:{pad(step,2)} </div> </div> </div> <div class="events" layout="row" layout-align="space-between"> <div layout="column" class="day" each="{day, rooms in schedule}"> <h2>{day}</h2> <div layout="column" each="{room, events in rooms}"> <h3>{room}</h3> <div class="event" each="{time, event in events}" riot-style=" background: hsl({event.hue}, 50%, 50%); top: {getTimeSpan(time).offset*scale}em; height: {getTimeSpan(time).height*scale}em"> <h4>{event.title}</h4> {event.description} </div> </div> </div> </div> </section> </div>', '', '', function (opts) {
	    var _this = this;
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('guest', '<h2>Guests of Honor</h2> <div each="{guest in guests.honor}"> <h3>{guest.name}</h3> {guest.description} </div> <h2>Community Guests</h2> <div each="{guest in guests.community}"> <h3>{guest.name}</h3> {guest.description} </div>', '', '', function (opts) {
	    this.guests = {
	        honor: [{
	            name: 'Michael',
	            description: 'Michael is the best guest we will have'
	        }],
	        community: [{
	            name: 'Michael',
	            description: 'Michael is the best guest we will have'
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('room', '<h2>Rooms</h2>', '', '', function (opts) {});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('vendor', '<h2>Vendors</h2> <div each="{vendor in vendors}"> {vendor.name} - Table # {vendor.table} Sells {vendor.inventory} </div>', '', '', function (opts) {
	    this.vendors = [{
	        name: 'Pinku',
	        table: 28,
	        inventory: ['Plüsch', 'Fanart']
	    }, {
	        name: 'Torben',
	        table: 29,
	        inventory: ['Sticker', 'Wooden Carvings']
	    }, {
	        name: 'Zunt',
	        table: '22-39',
	        inventory: ['Plüsch Imperium', 'Hasbro Zeug']
	    }];
	});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('supporter', '<h2>Supporter</h2>', '', '', function (opts) {});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('ludwigsburg', '<b>Map placeholder</b>', '', '', function (opts) {});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('team', '<h2>Team</h2> <div each="{member in members}"> <h3>{member.name}</h3> {member.position} {member.description} </div>', '', '', function (opts) {
	    this.members = [{
	        name: 'Saij',
	        position: 'Conchair',
	        description: 'Miau'
	        ...
	        name: 'Misan',
	        position: 'Webentwicklerli',
	        description: 'Miaut auch'
	    }];
	});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9)))
